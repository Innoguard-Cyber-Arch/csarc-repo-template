...
公版維護 renderer、governance、workflow 與 deterministic migration；專案維護產品 source、規格、決策與允許的內容覆寫。Create、adopt、update、conflict 與 preservation 都必須出現在 `./scripts/verify-template.sh` 的實際生成測資。
