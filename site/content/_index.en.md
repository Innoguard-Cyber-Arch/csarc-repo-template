...
| `.github/workflows/` | Nine shared flows: work item lifecycle (folding in Issue triage, Milestone sync, and work item closure), spec sync, PR rules, verification, scheduled vulnerability scanning, reviewer assignment, Dependabot auto-merge, a candidate release flow, and a release-publish drift check, plus the optional governance-drift and template-update-notice schedules, and CodeQL SAST | Template-led |
