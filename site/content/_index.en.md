...
{{< legacy >}}
      <header class="package-hero">
        ...
        <div class="package-badges" aria-label="Package status">
          ...
          <span class="package-badge muted">v0.25.8-beta.1</span><!-- x-release-please-version -->
...
<p class="template-version"><strong>Template release:</strong> v0.25.8-beta.1<!-- x-release-please-version --></p>
