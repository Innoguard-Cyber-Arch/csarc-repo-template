...
{{< legacy >}}
      <header class="package-hero">
        ...
        <div class="package-badges" aria-label="Package status">
          ...
          <span class="package-badge muted">v0.23.0</span><!-- x-release-please-version -->
...
<p class="template-version"><strong>Template release:</strong> v0.23.0<!-- x-release-please-version --></p>
...
Users do not need to memorize workflow or script names. Current automation covers work items, PR rules, necessary verification, and reviewed Milestone-promotion or standalone version candidates.
...
{{< slide key="deploy" track="deploy" eyebrow="Step 07" title="Separate version, release, and delivery; deployment is the project's own call" subtitle="A Milestone delivery PR carries its version; only standalone work needs a separate version PR. The template's job ends at Release, not deployment." class="legacy-slide decision-slide" legacy="true" >}}
{{< legacy >}}
      <header>
        <h2>Step 7｜<span class="accent">Version rules and what follows an artifact</span></h2>
        <p class="subtitle"><strong>Merging is not releasing, and releasing is not deploying.</strong> A work PR never edits the version directly; the Milestone promotion PR centralizes version and CHANGELOG updates at the delivery boundary.</p>
      </header>
      <p class="context-line"><strong>Design flow｜</strong>a work PR only declares version impact; the Milestone promotion PR reviews the batch and exact version together, then the system creates and verifies the Release and closes the tracker and Milestone.</p>
...
| Exact version and changelog | Candidate / Guided | A Milestone promotion PR carries them directly; standalone Automatic uses Release Please, while Guided uses a normal PR opened by a person or agent |
| Tag and GitHub Release | Candidate / Blocked | The shared publisher runs after a promotion or standalone version PR and then closes a successful Milestone |
...
{{< slide key="bridge" audience="maintainer" eyebrow="May 2026 internal presentation" title="Review the original principles against today's implementation" subtitle="Revisits the SDLC ideas shared internally in May 2026 and marks what is retained, adjusted, or deferred; click a row for the three-sentence call." class="legacy-slide bridge-slide" legacy="false" >}}
      ...
      <table class="bridge-table" aria-label="Page-by-page comparison of the May deck and today's design">
        ...
        <tbody>
          ...
          <tr><td>p.8</td><td>CD project management</td><td><span class="bridge-status adjust">Adjust</span></td><td><details class="bridge-detail drop-down"><summary>Milestones review delivery and version together; standalone work keeps a version PR</summary><div class="bridge-popover"><p><strong>May deck｜</strong>The original default was DEV → STAGING → Canary → PROD; this round does not require every project to copy all four tiers.</p><p><strong>This round｜</strong>A CSARC-owned Milestone promotion PR carries repository delivery, the version, and the changelog together; standalone work and hotfixes open a version PR only when needed.</p><p><strong>Implementation｜</strong>After promotion merges, the shared publisher creates the checksum, SBOM, artifact, and immutable GitHub Release, then closes the tracker and Milestone. Attestation and consumption-side gates stay optional.</p></div></details></td></tr>
