...
{{< legacy >}}
      <header>
        ...
        <p class="subtitle">共用規則與 7 條 GitHub Actions 每個 repo 都有；治理漂移排程與語言工具再依設定產生。</p>
      </header>
      <div class="repo-map-window" aria-label="模板產生檔案的視覺對照">
        ...
        <div class="repo-tree-body">
          ...
          <div class="repo-tree-row"><span class="repo-tree-path depth-1 folder">workflows/</span><span class="repo-tree-purpose"><span class="journey-code">01／03／04／05／08</span><span class="purpose-copy">7 條共用流程＋1 條選配排程</span></span><span class="scope-badge shared">共用</span><span class="owner-badge template">公版主導</span></div>
...
| `.github/workflows/` | 7 條共用流程，加上選配的治理漂移排程 | 公版主導 |
