...
更新一律經過 PR 審查，不會有人或程式偷偷覆寫你寫好的內容；遇到衝突，模板只負責告訴你哪些檔案受影響，不會自己動手改。

模板已經幫你接好常用工具：專案產生與更新、程式碼安全掃描、相依套件更新提醒、已知漏洞掃描、發版紀錄，還有你正在看的這個內部網站——不用自己另外找或設定。
{{< /standard >}}
