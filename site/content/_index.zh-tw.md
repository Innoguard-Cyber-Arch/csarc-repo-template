...
| `.github/workflows/` | 10 條共用流程：工作單整理、里程碑同步、規格開單、PR 規則、必要驗證、漏洞排程、reviewer 指派、工作關單、Dependabot 自動合併與候選發版，加上選配的治理漂移、模板更新通知排程與 CodeQL SAST | 公版主導 |
