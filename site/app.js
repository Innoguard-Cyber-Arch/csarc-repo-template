...
pnpm exec vitest run --coverage`
        },
        {
          ...
          summary: 'Issue 標題與 PR policy 回歸案例檢查標籤、標題、stack base、Issue，以及 main／Milestone delivery routes；公版再注入錯誤 Python／TypeScript 檔。',
  ...
  "parameters": {
    ...
    "required_review_thread_resolution": true
        ...
        },
        {
          ...
          summary: 'PR 至少選一個工作標籤；分支須為 `type/123-short-slug`，base 的 open PR 鏈須回到 main 或對應的短命 Milestone delivery branch，且連結 Issue 必須未結案、標題合格。',
      ...
      'template-release': [
        {
          ...
          summary: '語言與分支模式都在建立時明確選擇；main 是唯一永久 branch，delivery 模式只在 Milestone 期間增加短命整合 branch。`_skip_if_exists` 保護 src、tests、spec 不被更新覆寫。',
          file: 'copier.yml',
