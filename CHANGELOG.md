...
* fix(ci): check clean sync evidence against the full toolchain (bb2a271)

## [0.28.7] - 2026-09-26

### Bug Fixes

* fix(ci): accept squash-merged main evidence in clean syncs (5bef77c)

## [0.28.6] - 2026-09-25

### Bug Fixes

* fix(ci): queue superseded review publications instead of cancelling (94d72cc)

## [0.28.5] - 2026-09-25

### Bug Fixes

* fix(ci): keep the heartbeat from running the caller's EXIT trap (d5562f6)

## [0.28.4] - 2026-09-25

### Bug Fixes

* fix(governance): accept CRLF promotion fallback comments (59eb452)

## [0.28.3] - 2026-09-25

### Bug Fixes

* fix(release): plan squashed promotions from their bridge head (3470a15)
...
* fix: open delivery sync PRs as Draft until labelled (1e2d644)

## [0.26.8] - 2026-09-24

### Bug Fixes

* fix: treat work closed before #816 as historical (2d8429d)
...
* fix: accept CRLF merge authorization comments (ba9ae61)
